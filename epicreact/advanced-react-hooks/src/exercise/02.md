...
La memorización/cache sirve para no realizar calculos computacionales e
innecesarios cuando de entrada se está reciviendo el mismo dato que ya se tiene
almacenado. Lo cual ahorra mucho tiempo de ejecución.
...
La idea básica es retornar el mismo valor en la salida, si el valor de entrada
ya existe. Ayuda a mejorar el rendimiento.
